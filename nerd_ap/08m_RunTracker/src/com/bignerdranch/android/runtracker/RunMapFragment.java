...
public class RunMapFragment extends SupportMapFragment implements
	...
	private void updateUI() {
		...
		// Use the size of the current dsiplay in pizels as a bounding box
	...
	@Override
	public void onLoadFinished(Loader<Cursor> loader, Cursor curosr) {
		mLocationCursor = (LocationCursor) curosr;
		updateUI();
	}
