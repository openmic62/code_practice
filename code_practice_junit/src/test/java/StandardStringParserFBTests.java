 ...
 ***** build the Tests StandardStringParserFBTests
 J:\src\main\java>cd ..\..\test\java
 J:\src\test\java>l
 J:\src\test\java>echo %CLASSPATH%
 J:\src\test\java>javac -cp %CLASSPATH%;..\..\..\target\classes;..\..\..\target\test-classes -d ..\..\..\target\test-classes FillInTheBlanksStringParserTests.java StandardStringParserFBTests.java
 ***** run the Tests
 J:\src\test\java>java  -cp %CLASSPATH%;..\..\..\target\classes;..\..\..\target\test-classes org.junit.runner.JUnitCore StandardStringParserFBTests
 */ 
...
public class StandardStringParserFBTests extends FillInTheBlanksStringParserTests {
