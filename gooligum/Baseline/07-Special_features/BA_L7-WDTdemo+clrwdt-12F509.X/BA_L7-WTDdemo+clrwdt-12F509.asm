;************************************************************************
;                                                                       *
;   Filename:      BA_L7-WDTdemo+clrwdt-12F509.asm                 *
;   Date:          06/3/2018                                           *
;   File Version:  1.1                                                  *
;                                                                       *
;   Author:        Mike Rocha                                           *
...
;************************************************************************
;                                                                       *
;   Description:    Lesson 7, p. 9b  
;                                                                       *
;   Demonstrates watchdog timer used to turn off an LED                                                      *
;                                                                       *
;   Turn on LED.                                                        *
;   Turn delay 1 S the turn off the LED                                 *
;   Go into infinite loop; further behaivor independent if WDT is on or off *
;                                                                       *
;************************************************************************
;                                                                       *
;   Pin assignments:                                                    *
...
loop	clrwdt                    ; stop WDT from expiring ... LED will light once then stay off
	goto    loop
